...
<body>
    <nav class="barra navbar navbar-expand-lg" style="background-color:rgb(63, 33, 12)">
            ...
            <div class="container d-flex flex-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active text-warning" aria-current="page" href="{{ route('breweries') }}">{{ env('APP_NAME') }}</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="text-center text-white fixed-bottom" style="background-color: rgb(63, 33, 12)">
